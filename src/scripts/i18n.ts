...
export const translations = {
  en: {
    ...
    "nav_pdfscanner": "> cd /projects/pdfscanner",
    ...
    "pdfscanner_title": "M24 PDF Scanner",
    "pdfscanner_desc": "Privacy-focused Android app for scanning, editing, securing, and organizing PDFs directly on-device.",
    "pdfscanner_features": "ML Kit scan & OCR, Merge/Split/Rotate, Annotations & signatures, Secure redaction, Password protection",
    "pdfscanner_tech": "Kotlin, Jetpack Compose, Hilt, Room, ML Kit, PdfBox-Android",
    "pdfscanner_cta": "$ open play store",
    "pdfscanner_repo": "$ git clone repo",
  ...
  de: {
    ...
    "pst_repo": "$ git clone repo",
    "pdfscanner_title": "M24 PDF Scanner",
    "pdfscanner_desc": "Datenschutzorientierte Android-App zum Scannen, Bearbeiten, Schützen und Organisieren von PDFs direkt am Gerät.",
    "pdfscanner_features": "ML Kit Scan & OCR, Zusammenfügen/Teilen/Drehen, Anmerkungen & Signaturen, Sichere Schwärzung, Passwortschutz",
    "pdfscanner_tech": "Kotlin, Jetpack Compose, Hilt, Room, ML Kit, PdfBox-Android",
    "pdfscanner_cta": "$ open play store",
    "pdfscanner_repo": "$ git clone repo",
